...
<div class="wrap bfg-admin-page bfg-admin-page__kitchen-sink">
	<div class="bfg-page__main">
		...
		<!-- Boxes & Containers -->
		<bfg-box title="Boxes & Containers" description="Primary container component used throughout the admin">
			<p><strong>Classes:</strong> <code>.bfg-box</code>, <code>.bfg-box__header</code>,
				<code>.bfg-box__section</code></p>
			<p><bfg-t>Use .bfg-box for main content sections. Contains header with title/description and section for content.</bfg-t>
			</p>
		</bfg-box>

		<!-- Typography -->
		<bfg-box title="Typography">
			<h1>Heading 1</h1>
			<h2>Heading 2</h2>
		...
		<!-- Buttons & Links -->
		<bfg-box title="Buttons">
			<div class="bfgu:flex bfgu:gap-4 bfgu:mb-5">
				<button
					class="bfg-btn bfg-btn--primary"><bfg-t>Primary Button</bfg-t></button>
				<button
					class="bfg-btn bfg-btn--secondary"><bfg-t>Secondary Button</bfg-t></button>
				<button
					class="bfg-btn bfg-btn--primary bfg-btn--lg"><bfg-t>Large Primary</bfg-t></button>
			</div>
			<div class="bfgu:flex bfgu:gap-4">
				<button
					class="bfg-btn bfg-btn--primary bfg-btn--full-width"><bfg-t>Full Width Button</bfg-t></button>
			</div>
		...
		<!-- Form Fields -->
		<bfg-box title="Form Fields">
			<h3 class="bfg-field-group-title">
				<bfg-t>Text Inputs</bfg-t></h3>
			...
			<bfg-field.number
				id="demo-number-lg"
				name="demo-number-lg"
				label="Number Input with Large Suffix"
				value="250"
				suffix-lg="NOK" />

			<h3 class="bfg-field-group-title">
				<bfg-t>Select Dropdowns</bfg-t></h3>
		...
		<bfg-box title="Flex Layout Utilities">
			<h3 class="bfg-field-group-title">
				<bfg-t>Flex Row with Gap</bfg-t></h3>
		...
		<!-- Feature List -->
		<bfg-box title="Feature Lists">
			<h3 class="bfg-field-group-title">
				<bfg-t>Regular Feature List</bfg-t></h3>
			<bfg-feature-list>
			...
			<h3 class="bfg-field-group-title">
				<bfg-t>Compact Feature List</bfg-t></h3>
		...
		<bfg-box title="PRO Teaser Components">
			<div class="bfg-box bfg-pro-teaser-v2">
				...
				<h2 class="bfg-pro-teaser__title">
					<bfg-t>PRO Teaser Example</bfg-t></h2>
		...
		<!-- Active Step Card -->
		<bfg-box title="Active Step Card">
		...
		<bfg-box title="Component CSS Reference">
			<h3 class="bfg-field-group-title">
				<bfg-t>Main Classes</bfg-t></h3>
			<ul>
			...
			<h3 class="bfg-field-group-title">
				<bfg-t>Utility Classes</bfg-t></h3>
			<ul>
