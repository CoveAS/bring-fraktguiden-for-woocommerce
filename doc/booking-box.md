...
A failed save turns the Book button off. The next save that works turns it on
again. A booking of an unsaved form is refused, because the shop worker cannot
see what the order now holds.
