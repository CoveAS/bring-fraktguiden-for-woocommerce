...
<div class="bfg-section bfg-pro-free-state">
	...
	<div class="bfg-free-card bfg-active-notice">
		<div class="bfg-active-notice__body">
			<?php if ($license_testing): ?>
				<strong class="bfg-active-notice__title"><t>Pro is active on a test license</t></strong>
				<p class="bfg-active-notice__desc"><t>All Pro features are enabled. Bring never ships or invoices a booking from this site.</t></p>
			<?php else: ?>
	...
	<!-- License Card -->
	<bfg-license-card
		:title="esc_html( $license_testing ? __( 'Pro Test License', 'bring-fraktguiden-for-woocommerce' ) : __( 'Pro License', 'bring-fraktguiden-for-woocommerce' ) )"
		:subtitle="$valid_to_formatted ? sprintf( __( 'Active until %s', 'bring-fraktguiden-for-woocommerce' ), esc_html( $valid_to_formatted ) ) : ''"
		:status="esc_html( $license_testing ? __( 'Test mode', 'bring-fraktguiden-for-woocommerce' ) : __( 'Active', 'bring-fraktguiden-for-woocommerce' ) )"
		:status-color="$license_testing ? 'gray' : 'green'"
