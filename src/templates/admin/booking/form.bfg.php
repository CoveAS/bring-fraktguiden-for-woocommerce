...
<div class="bfg-booking-form" data-bfg-form data-token="<?php echo esc_attr($token); ?>">
	...
	<div class="bfg-booking-card">
		<h4 class="bfg-booking-card__title"><t>Shipment</t></h4>
	...
	<div class="bfg-booking-card">
		<h4 class="bfg-booking-card__title"><t>Packages</t></h4>
	...
	<?php if ($service && $service->vas) : ?>
		<div class="bfg-booking-card">
			<h4 class="bfg-booking-card__title"><t>Extra services</t></h4>
	...
	<div class="bfg-booking-card">
		<h4 class="bfg-booking-card__title"><t>Addresses</t></h4>
