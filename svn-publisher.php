...
if ( $result ) die( "ERROR: Could not get changes from git repo.\n" );
unset( $output );
// if ( ! empty( $output ) ) die( "ERROR: There are uncommited changes in the git repo.\n" );
exec( 'git tag --contains', $output, $result );
if ( $result ) die( "ERROR: Could not get tags from git repo.\n" );
if ( empty( $output ) ) die( "ERROR: No version tag found for the current git commit.\n" );
...
if ( $result ) die( "ERROR: Could not get tags from svn repo.\n" );
$tags = $output;
...
if ( $result ) die( "ERROR: Could not remove trunk.\n" );

// Copy from git repo
exec( 'cp -r "'. $dir .'/" trunk/', $output, $result );
if ( $result ) die( "ERROR: Copying git repo failed.\n" );
...
if ( $result ) die( "ERROR: Could not stage svn changes.\n" );
...
if ( $result ) die( "ERROR: Failed to commit to SVN.\n" );
chdir( '..' );
exec( "svn cp trunk tags/$version", $output, $result );
if ( $result ) die( "ERROR: Failed to copy the trunk to a new tag.\n" );
