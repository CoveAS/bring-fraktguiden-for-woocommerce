...
class Post_Type_Mailbox_Label {
	...
	static function label_post_type() {
		$labels = array(
			...
			'archives'              => __( 'Mailbox Label Archives', 'bring-fraktguiden' ),
			'attributes'            => __( 'Mailbox Label Attributes', 'bring-fraktguiden' ),
			'parent_item_colon'     => __( 'Parent Mailbox Label:', 'bring-fraktguiden' ),
			'all_items'             => __( 'All Mailbox Labels', 'bring-fraktguiden' ),
			'add_new_item'          => __( 'Add New Mailbox Label', 'bring-fraktguiden' ),
			'add_new'               => __( 'Add New', 'bring-fraktguiden' ),
			'new_item'              => __( 'New Mailbox Label', 'bring-fraktguiden' ),
			'edit_item'             => __( 'Edit Mailbox Label', 'bring-fraktguiden' ),
			'update_item'           => __( 'Update Mailbox Label', 'bring-fraktguiden' ),
			'view_item'             => __( 'View Mailbox Label', 'bring-fraktguiden' ),
			'view_items'            => __( 'View Mailbox Labels', 'bring-fraktguiden' ),
			'search_items'          => __( 'Search Mailbox Label', 'bring-fraktguiden' ),
			...
			'insert_into_item'      => __( 'Insert into Mailbox Label', 'bring-fraktguiden' ),
			'uploaded_to_this_item' => __( 'Uploaded to this Mailbox Label', 'bring-fraktguiden' ),
			'items_list'            => __( 'Mailbox Labels list', 'bring-fraktguiden' ),
			'items_list_navigation' => __( 'Mailbox Labels list navigation', 'bring-fraktguiden' ),
			'filter_items_list'     => __( 'Filter Mailbox Labels list', 'bring-fraktguiden' ),
		);
		$args   = array(
